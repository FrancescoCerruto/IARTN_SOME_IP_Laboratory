...
void callMethod(std::shared_ptr<HelloWorldProxy<>> myProxy) {
...
int main() {    
    ...
    std::string instance = "commonapi.examples.HelloWorld.Instance_1";
    std::string connection = "HelloWorld_Instance_1_client";
